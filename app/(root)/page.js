  ...
  const features = [
    {
      ...
      description: "Practice with real-world coding challanges and get instant feedback on your solution",
    },
    {
    ...
    },
    {
      ...
      description: "Learn from thousands of developers worldwideand share your knowledge"
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Real-time Feedack",
    ...
    <div className="min-h-screen  transition-colors mt-24">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-4 pt-16">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <Badge
            variant="secondary"
            className="mb-8 bg-amber-50 dark:bg-amber-950 text-amber-700 dark:text-amber-300 border-amber-500 dark:border-amber-800 hover:bg-amber-100 dark:hover:bg-amber-900"
          >
          ...
          <h1 className="text-2xl md:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white leading-tight mb-8">
            ...
            <span className="relative inline-block">
              <span className="px-6 py-3 bg-amber-500 dark:bg-amber-400 text-white dark:text-gray-900 rounded-4xl transform -rotate-3 inline-block shadow-lg">
                Problem
              </span>
            </span>{" "}
            Solving
            ...
            with{" "}
            <span className="relative inline-block">
              <span className="px-6 py-3 bg-indigo-600 dark:bg-indigo-500 text-white rounded-4xl transform rotate-2 inline-block shadow-lg">
                Code
              </span>
            </span>
          </h1>
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto mb-3">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {problemCategories.map((category, index) => (
              <Card
                key={index}
                className={`border-2 hover:shadow-lg hover:dark:shadow-lg hover:dark:shadow-white/10 transition-all duration-200 ${
      ...
      <section className="py-24 bg-linear-to-r from-amber-600 to-amber-300  dark:from-amber-600 dark:to-indigo-600 rounded-md">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-700 dark:text-white d mb-6">
